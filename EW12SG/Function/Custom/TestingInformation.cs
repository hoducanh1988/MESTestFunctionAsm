...
namespace EW12SG.Function.Custom {
    ...
    public class TestingInformation : INotifyPropertyChanged {
        ...
        string _validate_lan;
        public string ValidateLanPort {
            get { return _validate_lan; }
            set {
                _validate_lan = value;
                OnPropertyChanged(nameof(ValidateLanPort));
            }
        }
        ...
        bool _is_validate_lan;
        public bool IsValidateLanPort {
            get { return _is_validate_lan; }
            set {
                _is_validate_lan = value;
                OnPropertyChanged(nameof(IsValidateLanPort));
            }
        }
