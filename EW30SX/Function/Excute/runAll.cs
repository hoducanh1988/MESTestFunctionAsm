    ...
    public class runAll {
        ...
        Dictionary<string, validateinfo> dictValidateItem = new Dictionary<string, validateinfo>() {
            ...
            { "model", new validateinfo() { Title = "KIỂM TRA THÔNG TIN MODEL NUMBER",
                                                      ...
                                                      retry = 3 }},
            { "wanspeed", new validateinfo() { Title = "KIỂM TRA THÔNG TIN SPEED WAN PORT",
                                                      resultVariable = "ValidateWanPort",
                                                      standardValue = myGlobal.mySetting.SpeedWan,
                                                      meshMethod = "getWanSpeed",
                                                      retry = 3 }},
            { "lanspeed", new validateinfo() { Title = "KIỂM TRA THÔNG TIN SPEED LAN PORT",
                                                      resultVariable = "ValidateLanPort",
                                                      standardValue = myGlobal.mySetting.SpeedLan,
                                                      meshMethod = "getLanSpeed",
                                                      retry = 3 }},
        };
        ...
        public bool Excute() {
            ...
            //7. validate lan port
            //---------------------------------------//
            if (myTesting.IsValidateLanPort) {
                r = validateItem(dictValidateItem["lanspeed"]);
